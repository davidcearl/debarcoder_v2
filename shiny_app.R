library(shiny)
source('./modules/setup_module.R')
source('./modules/fcb_select_module.R')
source('./modules/debarcoder_module.R')
source('./modules/assign_split_module.R')
source('./modules/upload_module.R')
source('./modules/sample_tag_module.R')
